...
SimpleTypeChecker.set_(SimpleTypeChecker.walk_bool_to_bool, *ALL_LTL)

from pysmt.oracles import FreeVarsOracle
FreeVarsOracle.set_(FreeVarsOracle.walk_simple_args, *ALL_LTL)
...
from pysmt.walkers.generic import nodetypes
...
class HRPrinter(pysmt.printers.HRPrinter):
    ...
    @nodetypes(LTL_X, LTL_Y, LTL_Z, LTL_F, LTL_G, LTL_O, LTL_H)
...
IdentityDagWalker.set_(walk_ltl_x, LTL_X)
IdentityDagWalker.set_(walk_ltl_y, LTL_Y)
IdentityDagWalker.set_(walk_ltl_u, LTL_U)
IdentityDagWalker.set_(walk_ltl_s, LTL_S)
IdentityDagWalker.set_(walk_ltl_f, LTL_F)
IdentityDagWalker.set_(walk_ltl_g, LTL_G)
IdentityDagWalker.set_(walk_ltl_o, LTL_O)
IdentityDagWalker.set_(walk_ltl_h, LTL_H)
